...
class UiLanguageAndProgressTest(unittest.TestCase):
    ...
    def test_dashboard_is_english(self):
        self.assertEqual(module.APP_VERSION, "0.5.0-rc.5")
        ...
        self.assertIn(b'class="version">0.5.0-rc.5</span>', response.data)
    ...
    def test_running_progress_page_refreshes_and_lists_real_stage(self):
        ...
        self.assertIn(b"<div>0.5.0-rc.5</div>", response.data)
