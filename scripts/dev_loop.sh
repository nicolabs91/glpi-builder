...
docker run --rm --entrypoint sh "$IMAGE" -c \
    'python tests/test_yaml_contract.py && python tests/test_locked_yaml_output.py && python tests/test_static_security.py && python tests/test_preview_flow.py && python tests/test_ui_language_progress.py'
