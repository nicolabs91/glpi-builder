...
CMD ["sh", "-c", "python -c 'import app; app.install_backup_runtime()' && exec gunicorn --bind=0.0.0.0:8080 --workers=1 --threads=4 --timeout=600 --access-logfile=- --error-logfile=- app:app"]
